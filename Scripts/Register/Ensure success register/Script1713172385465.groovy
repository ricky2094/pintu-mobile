...
Mobile.verifyElementVisible(findTestObject('Register Page/BUTTON-register'), 0)
...
Mobile.setText(findTestObject('Register Page/INPUT-confirmPassword'), GlobalVariable.validPassword, 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Register Page/BUTTON-register'), 0)

Mobile.verifyElementVisible(findTestObject('Register Page/ALERT-Registration Successful'), 0)
